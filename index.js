...
let mapOne = fifaData.filter(function (item) {
  return item["Year"] === 2014 && item["Stage"] === "Final";
});

console.log(mapOne);
console.log("1A", mapOne[0]["Home Team Name"]);
console.log("1B", mapOne[0]["Away Team Name"]);
console.log("1C", mapOne[0]["Home Team Goals"]);
console.log("1D", mapOne[0]["Away Team Goals"]);
console.log("1E", mapOne[0]["Win conditions"]);
...
//   let winners = callback.filter(function (item) {
...
console.log(
  getWinnersByYear(
    getYears(getFinals(finalsData)),
    getWinners(getFinals(finalsData))
  )
);
